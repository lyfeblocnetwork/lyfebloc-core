...
## Your environment
- OS and version.
- The version of the Lyfebloc Core.    
  (*Confirm the version of your Lyfebloc Network client by running the following command: `lyfebloc-core version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `lyfebloc-core peers list --grpc-address GRPC_ADDRESS`.
